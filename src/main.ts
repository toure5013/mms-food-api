...
async function bootstrap() {
  ...
  // Utilisation de Winston comme logger global par défaut
  ...
  // CORS
  app.enableCors({
    origin: true, // Allow all origins for dev / mobile / web clients
    credentials: true,
  });
  ...
  const config = new DocumentBuilder()
    ...
    .setDescription(
      `## Plateforme SaaS de Restauration Collective B2B
